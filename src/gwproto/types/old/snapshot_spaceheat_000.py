...
class SnapshotSpaceheat000(BaseModel):
    """ """
    ...
    Snapshot: TelemetrySnapshotSpaceheat000 = Field(
        title="Snapshot",
    )
...
class SnapshotSpaceheat000_Maker:
    ...
    def __init__(
        ...
        snapshot: TelemetrySnapshotSpaceheat000,
    ):
        self.tuple = SnapshotSpaceheat000(
    ...
    @classmethod
    def tuple_to_type(cls, tuple: SnapshotSpaceheat000) -> bytes:
        """
    ...
    @classmethod
    def type_to_tuple(cls, t: bytes) -> SnapshotSpaceheat000:
        """
    ...
    @classmethod
    def dict_to_tuple(cls, d: dict[str, Any]) -> SnapshotSpaceheat000:
        """
        ...
        snapshot = TelemetrySnapshotSpaceheat000_Maker.dict_to_tuple(d2["Snapshot"])
        ...
        if d2["Version"] != "000":
            ...
            d2["Version"] = "000"
        return SnapshotSpaceheat000(**d2)
