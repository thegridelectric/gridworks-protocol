...
class TelemetrySnapshotSpaceheat000(BaseModel):
    """
...
class TelemetrySnapshotSpaceheat000_Maker:
    ...
    def __init__(
        ...
        self.tuple = TelemetrySnapshotSpaceheat000(
    ...
    @classmethod
    def tuple_to_type(cls, tuple: TelemetrySnapshotSpaceheat000) -> bytes:
        """
    ...
    @classmethod
    def type_to_tuple(cls, t: bytes) -> TelemetrySnapshotSpaceheat000:
        """
    ...
    @classmethod
    def dict_to_tuple(cls, d: dict[str, Any]) -> TelemetrySnapshotSpaceheat000:
        """
        ...
        if d2["Version"] != "000":
            ...
            d2["Version"] = "000"
        return TelemetrySnapshotSpaceheat000(**d2)
