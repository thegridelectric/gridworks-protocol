...
**Trigger**:
    - Description: Trigger. This is meant to be an event that triggers a cascade of other events, transitions and actions in the Spaceheat Nodes of the SCADA.  This comes from the language of Finite State Machines
...
.. autoclass:: gwproto.types.fsm_trigger_from_atn.check_is_uuid_canonical_textual
    :members:
