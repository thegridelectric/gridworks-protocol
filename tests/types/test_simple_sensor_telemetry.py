"""Tests simple.sensor.telemetry type, version 000"""
import json
...
from gwproto.types import SimpleSensorTelemetry_Maker as Maker


def test_simple_sensor_telemetry_generated() -> None:
    d = {
        "NameGtEnumSymbol": "c89d0ba1",
        "Value": 63430,
        "ScadaReadTimeUnixMs": 1656513094288,
        "TypeName": "simple.sensor.telemetry",
        "Version": "000",
    }
