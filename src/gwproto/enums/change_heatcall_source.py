...
class ChangeHeatcallSource(StrEnum):
    ...
    Enum change.heatcall.source version 000 in the GridWorks Type registry.
    ...
    gwproto. For more information:
      ...
      - [Global Authority](https://gridworks-type-registry.readthedocs.io/en/latest/enums.html#changeheatcallsource)
    ...
    def default(cls) -> "ChangeHeatcallSource":
        """
        Returns default value (in this case SwitchToWallThermostat)
        """
    ...
    def enum_name(cls) -> str:
        """
        The name in the GridWorks Type Registry (change.heatcall.source)
        """
    ...
    def symbol_to_value(cls, symbol: str) -> str:
        ...
        Returns:
            ...
            a later version of this enum, returns the default value of "SwitchToWallThermostat".
        """
    ...
    def value_to_symbol(cls, value: str) -> str:
        """
        Provides the encoding symbol for a ChangeHeatcallSource enum to send in seriliazed messages.
