...
from gwproto.types import Ads111xBasedCacGtMaker as Maker
...
def test_ads111x_based_cac_gt_generated() -> None:
    t = Ads111xBasedCacGt(
        ...
        ads_i2c_address_list=["0x4b", "0x48", "0x49"],
        total_terminal_blocks=12,
        telemetry_name_list=[
            TelemetryName.WaterTempCTimes1000,
            TelemetryName.AirTempCTimes1000,
        ],
        display_name="Gridworks 12-channel MultiTemp Ads Sensor",
    )
    ...
    d2["MakeModel"] = MakeModel.GRIDWORKS__MULTITEMP1.value
