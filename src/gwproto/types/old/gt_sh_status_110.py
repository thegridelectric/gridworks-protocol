...
class GtShStatus110(BaseModel):
    ...
    SimpleTelemetryList: List[GtShSimpleTelemetryStatus100] = Field(
        title="SimpleTelemetryList",
    )
    MultipurposeTelemetryList: List[GtShMultipurposeTelemetryStatus100] = Field(
        title="MultipurposeTelemetryList",
    )
    BooleanactuatorCmdList: List[GtShBooleanactuatorCmdStatus100] = Field(
...
class GtShStatus110_Maker:
    ...
    def __init__(
        ...
        simple_telemetry_list: List[GtShSimpleTelemetryStatus100],
        multipurpose_telemetry_list: List[GtShMultipurposeTelemetryStatus100],
        booleanactuator_cmd_list: List[GtShBooleanactuatorCmdStatus100],
        status_uid: str,
    ):
        self.tuple = GtShStatus110(
    ...
    @classmethod
    def tuple_to_type(cls, tuple: GtShStatus110) -> bytes:
        """
    ...
    @classmethod
    def type_to_tuple(cls, t: bytes) -> GtShStatus110:
        """
    ...
    @classmethod
    def dict_to_tuple(cls, d: dict[str, Any]) -> GtShStatus110:
        """
        ...
        for elt in d2["SimpleTelemetryList"]:
            ...
            t = GtShSimpleTelemetryStatus100_Maker.dict_to_tuple(elt)
        ...
        for elt in d2["MultipurposeTelemetryList"]:
            ...
            t = GtShMultipurposeTelemetryStatus100_Maker.dict_to_tuple(elt)
        ...
        for elt in d2["BooleanactuatorCmdList"]:
            ...
            t = GtShBooleanactuatorCmdStatus100_Maker.dict_to_tuple(elt)
