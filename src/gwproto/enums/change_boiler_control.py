...
class ChangeBoilerControl(StrEnum):
    ...
    def default(cls) -> "ChangeBoilerControl":
        """
        Returns default value (in this case SwitchToTankAquastat)
        """
    ...
    def symbol_to_value(cls, symbol: str) -> str:
        ...
        Returns:
            ...
            a later version of this enum, returns the default value of "SwitchToTankAquastat".
        """
    ...
    def value_to_symbol(cls, value: str) -> str:
        """
        Provides the encoding symbol for a ChangeBoilerControl enum to send in seriliazed messages.
