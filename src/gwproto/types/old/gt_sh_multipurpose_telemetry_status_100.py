...
class GtShMultipurposeTelemetryStatus100(BaseModel):
    """
...
class GtShMultipurposeTelemetryStatus100_Maker:
    ...
    def __init__(
        ...
        self.tuple = GtShMultipurposeTelemetryStatus100(
    ...
    @classmethod
    def tuple_to_type(cls, tuple: GtShMultipurposeTelemetryStatus100) -> bytes:
        """
    ...
    @classmethod
    def type_to_tuple(cls, t: bytes) -> GtShMultipurposeTelemetryStatus100:
        """
    ...
    @classmethod
    def dict_to_tuple(cls, d: dict[str, Any]) -> GtShMultipurposeTelemetryStatus100:
        """
        ...
        if d2["Version"] != "100":
            ...
            d2["Version"] = "100"
        return GtShMultipurposeTelemetryStatus100(**d2)
