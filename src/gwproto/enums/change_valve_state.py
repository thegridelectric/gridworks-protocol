...
class ChangeValveState(StrEnum):
    ...
    Enum change.valve.state version 000 in the GridWorks Type registry.
    ...
    gwproto. For more information:
      ...
      - [Global Authority](https://gridworks-type-registry.readthedocs.io/en/latest/enums.html#changevalvestate)
    ...
    def default(cls) -> "ChangeValveState":
        """
        Returns default value (in this case OpenValve)
        """
    ...
    def enum_name(cls) -> str:
        """
        The name in the GridWorks Type Registry (change.valve.state)
        """
    ...
    def symbol_to_value(cls, symbol: str) -> str:
        ...
        Returns:
            ...
            a later version of this enum, returns the default value of "OpenValve".
        """
    ...
    def value_to_symbol(cls, value: str) -> str:
        """
        Provides the encoding symbol for a ChangeValveState enum to send in seriliazed messages.
