...
class GtShBooleanactuatorCmdStatus100(BaseModel):
    """
...
class GtShBooleanactuatorCmdStatus100_Maker:
    ...
    def __init__(
        ...
        self.tuple = GtShBooleanactuatorCmdStatus100(
    ...
    @classmethod
    def tuple_to_type(cls, tuple: GtShBooleanactuatorCmdStatus100) -> bytes:
        """
    ...
    @classmethod
    def type_to_tuple(cls, t: bytes) -> GtShBooleanactuatorCmdStatus100:
        """
    ...
    @classmethod
    def dict_to_tuple(cls, d: dict[str, Any]) -> GtShBooleanactuatorCmdStatus100:
        """
        ...
        if d2["Version"] != "100":
            ...
            d2["Version"] = "100"
        return GtShBooleanactuatorCmdStatus100(**d2)
