...
class ChangeStoreFlowDirection(StrEnum):
    ...
    Enum change.store.flow.direction version 000 in the GridWorks Type registry.
    ...
    gwproto. For more information:
      ...
      - [Global Authority](https://gridworks-type-registry.readthedocs.io/en/latest/enums.html#changestoreflowdirection)
    ...
    def default(cls) -> "ChangeStoreFlowDirection":
        """
        Returns default value (in this case Discharge)
        """
    ...
    def enum_name(cls) -> str:
        """
        The name in the GridWorks Type Registry (change.store.flow.direction)
        """
    ...
    def symbol_to_value(cls, symbol: str) -> str:
        ...
        Returns:
            ...
            a later version of this enum, returns the default value of "Discharge".
        """
    ...
    def value_to_symbol(cls, value: str) -> str:
        """
        Provides the encoding symbol for a ChangeStoreFlowDirection enum to send in seriliazed messages.
