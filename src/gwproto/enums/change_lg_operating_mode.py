...
class ChangeLgOperatingMode(StrEnum):
    ...
    Enum change.lg.operating.mode version 000 in the GridWorks Type registry.
    ...
    gwproto. For more information:
      ...
      - [Global Authority](https://gridworks-type-registry.readthedocs.io/en/latest/enums.html#changelgoperatingmode)
    ...
    def enum_name(cls) -> str:
        """
        The name in the GridWorks Type Registry (change.lg.operating.mode)
        """
    ...
    def value_to_symbol(cls, value: str) -> str:
        """
        Provides the encoding symbol for a ChangeLgOperatingMode enum to send in seriliazed messages.
